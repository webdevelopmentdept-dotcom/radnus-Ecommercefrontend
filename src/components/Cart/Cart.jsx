...
const Cart = () => {
  ...
  const placeOrderHandler = () => {
    ...
    return (
        <>
            <MetaData title="Shopping Cart | Radnus" />
          <main className="w-full mt-16 sm:mt-20 px-2 sm:px-0">


                {/* <!-- row --> */}
<div className="flex flex-col lg:flex-row gap-4 w-full lg:w-11/12 mt-0 lg:mt-4 mx-auto mb-6 px-2 lg:px-0">
